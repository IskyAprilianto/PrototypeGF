...
st.caption("Catatan : Streamlit bisa saja tidak terhubung ke sever (backend flask) dikarenakan running pada replit(webhosting yang free) sering mati sendiri")
